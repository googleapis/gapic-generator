...
public class ResourceNameMessageConfigsTest {
  static final ProtoParser protoParser = Mockito.mock(ProtoParser.class);
  ...
  static final ImmutableList<ProtoFile> sourceProtoFiles = ImmutableList.of(protoFile);

  static final String DEFAULT_PACKAGE = "library";
  ...
  static final String ASTERISK_SHELF_PATH = "shelves/*";
  private static final String ASTERISK_BOOK_PATH = "bookShelves/*";

  static ConfigProto configProto =
