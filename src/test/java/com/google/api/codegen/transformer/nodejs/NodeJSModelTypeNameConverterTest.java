...
public class NodeJSModelTypeNameConverterTest {
  ...
  public void testGetEnumValue() {
    ...
    Truth.assertThat(
            converter
                .getEnumValue(type, "GOOD")
                .getValueAndSaveTypeNicknameIn(new NodeJSTypeTable(packageName)))
        .isEqualTo("gopherV1.SimpleRequest.Alignment.GOOD");
  }
}
