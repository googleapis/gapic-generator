...
/** Javascript discovery doc fragment generator baseline tests. */
@RunWith(Parameterized.class)
public class JSDiscoveryFragmentGeneratorTest extends DiscoveryGeneratorTestBase {

  public JSDiscoveryFragmentGeneratorTest(
    ...
    for (File file : dir.listFiles(new DiscoveryFile())) {
      ...
      builder.add(
          new Object[] {
            ...
            new String[] {"com/google/api/codegen/js/js_discovery.yaml"}
          });
    }
  ...
  public void putTestDirectory() {
    getTestDataLocator().addTestDataSource(this.getClass(), "testdata/discoveries/js");
  }
