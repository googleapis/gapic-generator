...
/**
 * Java test generator baseline tests.
 */
@RunWith(Parameterized.class)
public class JavaTestGeneratorTest extends GapicTestBase {

  public JavaTestGeneratorTest(
  ...
  public static List<Object[]> testedConfigs() {
    return GapicTestBase.createTestedConfigs(
        MainGapicProviderFactory.JAVA_TEST, new String[] {"java_test.yaml", "library_gapic.yaml"});
  }
