...
/**
 * Python discovery doc fragment generator baseline tests.
 */
@RunWith(Parameterized.class)
public class PythonDiscoveryFragmentGeneratorTest extends DiscoveryFragmentGeneratorTestBase {

  public PythonDiscoveryFragmentGeneratorTest(
    ...
    for (File file : dir.listFiles(new DiscoveryFile())) {
      ...
      builder.add(
          new Object[] {
            ...
            new String[] {"com/google/api/codegen/py/python_discovery.yaml"}
          });
    }
  ...
  public void putTestDirectory() {
    getTestDataLocator().addTestDataSource(this.getClass(), "testdata/discoveries/py");
  }
