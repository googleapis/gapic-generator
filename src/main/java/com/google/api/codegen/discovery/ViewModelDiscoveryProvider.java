...
public class ViewModelDiscoveryProvider implements DiscoveryProvider<Interface> {
  ...
  private ViewModelDiscoveryProvider(
  ...
  public Map<String, Doc> generate(Method method) {
    List<ViewModel> surfaceDocs = methodToViewTransformer.transform(method, apiaryConfig);

    Map<String, Doc> docs = new TreeMap<>();
    ViewModel surfaceDoc = surfaceDocs.get(0);
  ...
  public static class Builder {
    ...
    public ViewModelDiscoveryProvider build() {
      return new ViewModelDiscoveryProvider(
          apiaryConfig, snippetSetRunner, methodToViewTransformer);
    }
  }
}
