...
import com.google.api.codegen.nodejs.NodeJSClientConfigGapicContext;
...
import com.google.api.codegen.py.PythonClientConfigGapicContext;
...
import com.google.api.codegen.ruby.RubyClientConfigGapicContext;
    ...
    if (id.equals(CLIENT_CONFIG)) {
      ...
      GapicProvider<? extends Object> clientConfigProvider =
          CommonGapicProvider.<Interface>newBuilder()
              .setModel(model)
              .setView(new InterfaceView())
              .setContext(new NodeJSClientConfigGapicContext(model, apiConfig))
              .setSnippetSetRunner(new ClientConfigSnippetSetRunner<Interface>())
              .setSnippetFileNames(Arrays.asList("json.snip"))
              .build();
      ...
      GapicProvider<? extends Object> clientConfigProvider =
          CommonGapicProvider.<Interface>newBuilder()
              .setModel(model)
              .setView(new InterfaceView())
              .setContext(new PythonClientConfigGapicContext(model, apiConfig))
              .setSnippetSetRunner(new ClientConfigSnippetSetRunner<Interface>())
              .setSnippetFileNames(Arrays.asList("json.snip"))
              .build();
      ...
      GapicProvider<? extends Object> clientConfigProvider =
          CommonGapicProvider.<Interface>newBuilder()
              .setModel(model)
              .setView(new InterfaceView())
              .setContext(new RubyClientConfigGapicContext(model, apiConfig))
              .setSnippetSetRunner(new ClientConfigSnippetSetRunner<Interface>())
              .setSnippetFileNames(Arrays.asList("json.snip"))
              .build();
