...
@AutoValue
public abstract class StaticLangStubInterfaceView {
  ...
  public static StaticLangStubInterfaceView.Builder newBuilder() {
    return new AutoValue_StaticLangStubInterfaceView.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract StaticLangStubInterfaceView build();
  }
}
