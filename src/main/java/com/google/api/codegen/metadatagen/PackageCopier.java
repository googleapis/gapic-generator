...
public interface PackageCopier {
  ...
  /**
   * Returns a map of processed gRPC source code (as Docs), any package metadata generated in this
   * phase. Any data returned from this phase should be present in the map under the key specified
   * as copierMetadataKEy.
   */
