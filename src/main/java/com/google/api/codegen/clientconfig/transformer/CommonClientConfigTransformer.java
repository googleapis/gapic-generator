...
/** The ModelToViewTransformer to transform a Model into the client config. */
public class CommonClientConfigTransformer implements ModelToViewTransformer {
  private final GapicCodePathMapper pathMapper;

  private final ClientConfigTransformer clientConfigTransformer;

  public CommonClientConfigTransformer(GapicCodePathMapper pathMapper) {
