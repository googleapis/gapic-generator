 ...
 */
package com.google.api.codegen.clientconfig.transformer.php;

import com.google.api.codegen.clientconfig.transformer.BatchingTransformer;
import com.google.api.codegen.clientconfig.transformer.MethodTransformer;
import com.google.api.codegen.clientconfig.viewmodel.MethodView;
import com.google.api.codegen.config.MethodConfig;

public class PhpMethodTransformer implements MethodTransformer {
  ...
  public MethodView generateMethod(MethodConfig methodConfig) {
    ...
    method.isRetryingSupported(
        !retryCodesName.isEmpty() && !retryParamsName.isEmpty() && !methodConfig.isGrpcStreaming());
