...
public class PhpClientConfigTransformer implements ModelToViewTransformer {
  ...
  public PhpClientConfigTransformer(GapicCodePathMapper pathMapper) {
    ...
    this.clientConfigTransformer = new ClientConfigTransformer(new PhpMethodTransformer());
  }
