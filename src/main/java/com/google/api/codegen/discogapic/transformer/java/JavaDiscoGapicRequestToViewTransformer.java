...
public class JavaDiscoGapicRequestToViewTransformer implements DocumentToViewTransformer {
  ...
  private StaticLangApiMessageView generateRequestClass(
    ...
    String requestClassId =
        context
            ...
            .privateFieldName(
                context
                    .getDiscoGapicNamer()
                    .getRequestName(((DiscoveryMethodModel) method).getDiscoMethod()));
    String requestName =
    ...
    String resourceName =
        context.getDiscoGapicNamer().getResourceIdentifier(discoMethod.path()).toLowerCamel();
    ...
    if (requestBodyDef != null && !Strings.isNullOrEmpty(requestBodyDef.reference())) {
      ...
      requestView.requestBodyType(
          schemaToParamView(
              ...
              context
                  .getDiscoGapicNamer()
                  .getSchemaNameAsParameter(requestBodyDef.dereference())
                  .toLowerCamel(),
              symbolTable,
