...
public class CSharpStandaloneSampleTransformer extends StaticLangGapicSamplesTransformer {
  ...
  private static final ImmutableMap<CallingForm, ClientMethodType> CALLING_FORMS_CLIENT_METHOD_MAP =
      ImmutableMap.<CallingForm, ClientMethodType>builder()
          ...
          .put(
              CallingForm.RequestAsyncPagedPageSize, ClientMethodType.AsyncPagedRequestObjectMethod)
          ...
          .put(CallingForm.FlattenedAsyncPagedPageSize, ClientMethodType.PagedFlattenedAsyncMethod)
