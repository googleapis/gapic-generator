...
public class CSharpGapicSurfaceClientTransformer extends CSharpGapicSurfaceCommonTransformer {

  private final GapicCodePathMapper pathMapper;

  public CSharpGapicSurfaceClientTransformer(GapicCodePathMapper pathMapper) {
    this.pathMapper = pathMapper;
  }

  @Override
  protected String getTemplateFileName() {
    return "csharp/gapic_client.snip";
  }
  ...
  protected String getOutputPath(SurfaceTransformerContext context) {
    ...
    return outputPath + File.separator + name + ".cs";
  }
