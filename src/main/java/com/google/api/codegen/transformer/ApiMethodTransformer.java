...
public class ApiMethodTransformer {
  ...
  public StaticLangApiMethodView generatePagedFlattenedMethod(
    ...
    return generatePagedFlattenedMethod(
        context, flatteningGroup, Collections.<ParamWithSimpleDoc>emptyList());
  }
  ...
  public StaticLangApiMethodView generatePagedFlattenedMethod(
    ...
    setFlattenedMethodFields(
        context, flatteningGroup, additionalParams, Synchronicity.Sync, methodViewBuilder);
  ...
  public StaticLangApiMethodView generatePagedFlattenedAsyncMethod(
      MethodTransformerContext context, FlatteningConfig flattenedGroup) {
    return generatePagedFlattenedAsyncMethod(
        context, flattenedGroup, Collections.<ParamWithSimpleDoc>emptyList());
  }

  public StaticLangApiMethodView generatePagedFlattenedAsyncMethod(
      MethodTransformerContext context,
      FlatteningConfig flattenedGroup,
      List<ParamWithSimpleDoc> additionalParams) {
    SurfaceNamer namer = context.getNamer();
    StaticLangApiMethodView.Builder methodViewBuilder = StaticLangApiMethodView.newBuilder();
    ...
    setFlattenedMethodFields(
        context, flattenedGroup, additionalParams, Synchronicity.Async, methodViewBuilder);
  ...
  public StaticLangApiMethodView generateFlattenedAsyncMethod(
      MethodTransformerContext context, FlatteningConfig flattenedGroup, ApiMethodType type) {
    return generateFlattenedAsyncMethod(
        context, flattenedGroup, Collections.<ParamWithSimpleDoc>emptyList(), type);
  }
  ...
  public StaticLangApiMethodView generateFlattenedMethod(
      MethodTransformerContext context, FlatteningConfig flattenedGroup) {
    return generateFlattenedMethod(
        context, flattenedGroup, Collections.<ParamWithSimpleDoc>emptyList());
  }
  ...
  public StaticLangApiMethodView generateFlattenedMethod(
    ...
    methodViewBuilder.callableName(namer.getCallableName(context.getMethod()));
    setFlattenedMethodFields(
        context, flattenedGroup, additionalParams, Synchronicity.Sync, methodViewBuilder);
  ...
  private void setFlattenedMethodFields(
      ...
      StaticLangApiMethodView.Builder methodViewBuilder) {
    SurfaceNamer namer = context.getNamer();
    Iterable<FieldConfig> fieldConfigs = flatteningGroup.getFlattenedFieldConfigs().values();
    ...
    for (FieldConfig fieldConfig : flatteningGroup.getFlattenedFieldConfigs().values()) {
    ...
    methodViewBuilder.pathTemplateChecks(
        generatePathTemplateChecks(context, flatteningGroup.getFlattenedFieldConfigs().values()));
  }
