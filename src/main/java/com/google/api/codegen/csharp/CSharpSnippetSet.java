...
/**
 * Entry points for a C# snippet set. Generation is partitioned into a first phase which generates
 * the content of the class without namespace and using directives, and a second phase which
 * completes the class based on the knowledge of which other classes have been imported.
 */
interface CSharpSnippetSet<Element> {
