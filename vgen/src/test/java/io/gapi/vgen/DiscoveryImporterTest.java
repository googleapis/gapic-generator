...
public class DiscoveryImporterTest {
  private static Reader getReader(String file) throws IOException {
    file = "src/test/java/io/gapi/vgen/discoverytestdata/" + file;
  ...
  public void testMethod() throws IOException {
    ...
    Truth.assertThat(imp.getConfig().apiParams.get(method.getName()))
        .containsExactly("resource", "request$")
        .inOrder();
    Truth.assertThat(imp.getConfig().resources.get(method.getName()))
