...
/**
 * Language provider for Java discovery doc codegen.
 */
public class JavaDiscoveryLanguageProvider extends DiscoveryLanguageProvider {
  ...
  private static final String SNIPPET_RESOURCE_ROOT =
      JavaDiscoveryLanguageProvider.class.getPackage().getName().replace('.', '/');
  ...
  public void outputFragments(String outputPath, Multimap<Method, GeneratedResult> methods,
    ...
    String path = "autogenerated/" + api.getName() + "/" + api.getVersion() + "/0/";
